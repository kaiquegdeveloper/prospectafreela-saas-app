        ...
        @auth
            @if(!request()->is('prospects/create'))
                <a href="{{ route('prospects.create') }}" 
                   class="fixed bottom-6 right-6 z-50 inline-flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-full shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300 group font-semibold"
